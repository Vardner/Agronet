...
/***/ "./resources/js/frontend/dropdowns/dropdowns.js":
/*!******************************************************!*\
  !*** ./resources/js/frontend/dropdowns/dropdowns.js ***!
  \******************************************************/
/*! no static exports found */
...
function enableDropdowns() {
  var dropdownElements = $('[data-dropdown=toggle]');
...
function enableSeoExpand() {
  var showSeoButton = $('[data-control=show-seo]');
  ...
  function expandSeo() {
    var self = $(this);
    var seoContent = $('.main__seo-content');
    var currentHeight = seoContent.height();
    var expandedHeight = seoContent.css('height', 'auto').height();
    self.hide();
    seoContent.height(currentHeight);
    seoContent.stop().animate({
...
/***/ "./resources/js/frontend/sliders/sliders.js":
/*!**************************************************!*\
  !*** ./resources/js/frontend/sliders/sliders.js ***!
  \**************************************************/
/*! no static exports found */
